...
var convertMap = [][2]string{
	[2]string{
		...
		`"github.com/gopkg/encoding/proto"`,
	},
	[2]string{
		`"code.google.com/p/goprotobuf/protoc-gen-go/descriptor"`,
		`"github.com/gopkg/encoding/protoc-gen-go/descriptor"`,
	},
	[2]string{
		`"code.google.com/p/goprotobuf/protoc-gen-go/generator"`,
		`"github.com/gopkg/encoding/protoc-gen-go/generator"`,
	},
	[2]string{
		`"code.google.com/p/goprotobuf/protoc-gen-go/plugin"`,
		`"github.com/gopkg/encoding/protoc-gen-go/plugin"`,
	},
}
